...
class FireParticles : public Node {
    struct particle {
        engine::Vec2f pos;
        engine::Vec2f vel;
        sf::Time life = sf::Time::Zero;
    ...
    public:
    FireParticles(engine::Vec2f orig) {
        ResourceLoader::get_instance()->load_texture("res/textures/smoke/fire_particle.png");
        smoke_ptr = ResourceLoader::get_instance()->get_texture("fire_particle.png");
        changeOrigin(orig);
